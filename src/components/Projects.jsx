          ...
          <div className="projects-content">
            <div className="prj-header">
              ...
              <p className="work-sub">
                AI‑driven applications, full‑stack platforms, data science
                projects, and machine learning experiments that turn ideas into
                ...
                >
                  ...
                  >
                    {filteredProjects.map((project) => {
                      ...
                      const hasMoreTech =
                        project.tech.length > 4 && !isExpanded;
                          ...
                          <div className="work-card">
                            ...
                            <div className="work-card-tech">
                              {displayTech.map((t, techIdx) => (
                                <span
                                  key={t}
                                  className={`work-tech-tag${isExpanded && techIdx >= 4
                                      ? " tech-tag-new"
                                      : ""
                                    }`}
                                >
